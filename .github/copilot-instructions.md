# Copilot Instructions -- TypeScript Bun Starter

This file is consumed by GitHub Copilot repository custom instructions and mirrors the root repository contract.
