...
export class SkillCreateCommand extends Command {
    ...
    static usage = Command.Usage({
        ...
        examples: [
            ...
            ['Create with description', 'tbs skill create --name web-search --description "Search the web"'],
    ...
    async execute() {
        ...
        const description =
            this.description ?? (!this.json ? await prompts.promptText('Description', { optional: true }) : null);
